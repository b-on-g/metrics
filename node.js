...
var $;
(function ($) {
    $mol_style_define($bog_metrics_dashboard, {
        Navbar: {
            flex: {
                wrap: 'nowrap',
            },
...
;
	($.$bog_metrics_dashboard_overview) = class $bog_metrics_dashboard_overview extends ($.$mol_page) {
		dau(){
			return "0";
		}
		Dau_card(){
		...
		Pageviews_card(){
			const obj = new this.$.$bog_metrics_dashboard_stat_card();
			(obj.title) = () => ("Pageviews today");
			(obj.value) = () => ((this.pageviews_today()));
			return obj;
		}
		sessions_today(){
			return "0";
		...
		Sessions_card(){
			const obj = new this.$.$bog_metrics_dashboard_stat_card();
			(obj.title) = () => ("Sessions today");
			(obj.value) = () => ((this.sessions_today()));
			return obj;
		}
		Stats(){
		...
		Pageviews_bar(){
			...
			(obj.title) = () => ("Pageviews");
			(obj.series_y) = () => ((this.chart_pageviews_y()));
			return obj;
		}
		chart_day_labels(){
			return [];
		...
		Day_labels(){
			...
			(obj.title) = () => ("Day");
			(obj.labels) = () => ((this.chart_day_labels()));
			return obj;
		}
		Count_axis(){
		...
		Chart_section(){
			...
			(obj.title) = () => ("Pageviews by day");
			(obj.content) = () => ([(this.Chart())]);
			return obj;
		}
		Top_page_url(id){
			return "";
		...
		top_pages_rows(){
			return [(this.Top_page_row("0"))];
		}
		Top_pages_section(){
			const obj = new this.$.$mol_section();
			(obj.title) = () => ("Top pages");
			(obj.content) = () => ((this.top_pages_rows()));
			return obj;
		}
		Top_referrer_url(id){
			return "";
		...
		top_referrers_rows(){
			return [(this.Top_referrer_row("0"))];
		}
		Top_referrers_section(){
			const obj = new this.$.$mol_section();
			(obj.title) = () => ("Top referrers");
			(obj.content) = () => ((this.top_referrers_rows()));
			return obj;
		}
		title(){
			return "Overview";
		...
		body(){
			return [
				(this.Stats()), 
				(this.Chart_section()), 
				(this.Top_pages_section()), 
				(this.Top_referrers_section())
			];
		}
	};
	($mol_mem(($.$bog_metrics_dashboard_overview.prototype), "Dau_card"));
	($mol_mem(($.$bog_metrics_dashboard_overview.prototype), "Pageviews_card"));
	($mol_mem(($.$bog_metrics_dashboard_overview.prototype), "Sessions_card"));
	($mol_mem(($.$bog_metrics_dashboard_overview.prototype), "Stats"));
	($mol_mem(($.$bog_metrics_dashboard_overview.prototype), "Pageviews_bar"));
	($mol_mem(($.$bog_metrics_dashboard_overview.prototype), "Day_labels"));
	...
	($mol_mem(($.$bog_metrics_dashboard_stat_card.prototype), "Value"));
	($mol_mem(($.$bog_metrics_dashboard_stat_card.prototype), "Title"));
...
(function ($) {
    ...
    (function ($$) {
        class $bog_metrics_dashboard_overview extends $.$bog_metrics_dashboard_overview {
            ...
            sessions_today() {
                const start = this.today_start();
                const session_events = this.all_events().filter(e => e.type === 'session_start' && e.timestamp >= start);
        ...
        __decorate([
            $mol_mem
        ], $bog_metrics_dashboard_overview.prototype, "chart_data", null);
        __decorate([
            $mol_mem
        ], $bog_metrics_dashboard_overview.prototype, "top_pages_data", null);
        __decorate([
            $mol_mem
        ], $bog_metrics_dashboard_overview.prototype, "top_referrers_data", null);
        $$.$bog_metrics_dashboard_overview = $bog_metrics_dashboard_overview;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_metrics_dashboard_sessions) = class $bog_metrics_dashboard_sessions extends ($.$mol_page) {
		total_sessions(){
			return "0";
		}
		Total_card(){
			const obj = new this.$.$bog_metrics_dashboard_stat_card();
			(obj.title) = () => ("Total sessions");
			(obj.value) = () => ((this.total_sessions()));
			return obj;
		}
		avg_duration(){
			return "—";
		...
		Avg_duration_card(){
			const obj = new this.$.$bog_metrics_dashboard_stat_card();
			(obj.title) = () => ("Avg duration");
			(obj.value) = () => ((this.avg_duration()));
			return obj;
		}
		avg_pages(){
			return "0";
		...
		Session_duration(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.session_duration(id)));
			return obj;
		}
		session_pages(id){
			return "";
		...
		Session_pages(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.session_pages(id)));
			return obj;
		}
		session_time(id){
			return "";
		...
		Session_time(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.session_time(id)));
			return obj;
		}
		Session_row(id){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([
				(this.Session_uid(id)), 
				(this.Session_duration(id)), 
				(this.Session_pages(id)), 
				(this.Session_time(id))
			]);
			return obj;
		}
		session_rows(){
			return [(this.Session_row("0"))];
		}
		Sessions_list(){
			const obj = new this.$.$mol_section();
			(obj.title) = () => ("Recent sessions");
			(obj.content) = () => ((this.session_rows()));
			return obj;
		}
		title(){
			return "Sessions";
		...
		body(){
			return [(this.Summary()), (this.Sessions_list())];
		}
	};
	($mol_mem(($.$bog_metrics_dashboard_sessions.prototype), "Total_card"));
	($mol_mem(($.$bog_metrics_dashboard_sessions.prototype), "Avg_duration_card"));
	($mol_mem(($.$bog_metrics_dashboard_sessions.prototype), "Avg_pages_card"));
	($mol_mem(($.$bog_metrics_dashboard_sessions.prototype), "Summary"));
	($mol_mem_key(($.$bog_metrics_dashboard_sessions.prototype), "Session_uid"));
	($mol_mem_key(($.$bog_metrics_dashboard_sessions.prototype), "Session_duration"));
	($mol_mem_key(($.$bog_metrics_dashboard_sessions.prototype), "Session_pages"));
	($mol_mem_key(($.$bog_metrics_dashboard_sessions.prototype), "Session_time"));
	($mol_mem_key(($.$bog_metrics_dashboard_sessions.prototype), "Session_row"));
	($mol_mem(($.$bog_metrics_dashboard_sessions.prototype), "Sessions_list"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_metrics_dashboard_sessions extends $.$bog_metrics_dashboard_sessions {
            sessions_grouped() {
                const map = new Map();
                for (const ev of this.all_events()) {
                    ...
                    if (ev.timestamp < s.start)
                        s.start = ev.timestamp;
                    if (ev.timestamp > s.end)
                        s.end = ev.timestamp;
                    if (ev.type === 'pageview')
                        s.pageviews++;
                }
        ...
        __decorate([
            $mol_mem
        ], $bog_metrics_dashboard_sessions.prototype, "sessions_grouped", null);
        $$.$bog_metrics_dashboard_sessions = $bog_metrics_dashboard_sessions;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_metrics_dashboard_vitals) = class $bog_metrics_dashboard_vitals extends ($.$mol_page) {
		lcp_p75(){
			return "—";
		}
		Lcp_card(){
		...
		Time_labels(){
			const obj = new this.$.$mol_plot_mark_hor();
			(obj.title) = () => ("Time");
			(obj.labels) = () => ((this.chart_time_labels()));
			return obj;
		}
		Value_axis(){
			const obj = new this.$.$mol_plot_ruler_vert();
		...
		vital_rows(){
			return [(this.Vital_row("0"))];
		}
		Vitals_list(){
			const obj = new this.$.$mol_section();
			(obj.title) = () => ("Recent vitals");
			(obj.content) = () => ((this.vital_rows()));
			return obj;
		}
		title(){
			return "Vitals";
	...
	($mol_mem(($.$bog_metrics_dashboard_vitals.prototype), "Lcp_card"));
	($mol_mem(($.$bog_metrics_dashboard_vitals.prototype), "Inp_card"));
	($mol_mem(($.$bog_metrics_dashboard_vitals.prototype), "Cls_card"));
	($mol_mem(($.$bog_metrics_dashboard_vitals.prototype), "Summary"));
	($mol_mem(($.$bog_metrics_dashboard_vitals.prototype), "Lcp_line"));
	($mol_mem(($.$bog_metrics_dashboard_vitals.prototype), "Time_labels"));
	($mol_mem(($.$bog_metrics_dashboard_vitals.prototype), "Value_axis"));
	($mol_mem(($.$bog_metrics_dashboard_vitals.prototype), "Chart"));
	($mol_mem(($.$bog_metrics_dashboard_vitals.prototype), "Chart_section"));
	($mol_mem_key(($.$bog_metrics_dashboard_vitals.prototype), "Vital_name"));
	($mol_mem_key(($.$bog_metrics_dashboard_vitals.prototype), "Vital_value"));
	($mol_mem_key(($.$bog_metrics_dashboard_vitals.prototype), "Vital_time"));
	($mol_mem_key(($.$bog_metrics_dashboard_vitals.prototype), "Vital_row"));
	($mol_mem(($.$bog_metrics_dashboard_vitals.prototype), "Vitals_list"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_metrics_dashboard_vitals extends $.$bog_metrics_dashboard_vitals {
            vital_events() {
                return this.all_events()
        ...
        __decorate([
            $mol_mem
        ], $bog_metrics_dashboard_vitals.prototype, "vital_events", null);
        __decorate([
            $mol_mem
        ], $bog_metrics_dashboard_vitals.prototype, "chart_lcp_data", null);
        $$.$bog_metrics_dashboard_vitals = $bog_metrics_dashboard_vitals;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_metrics_dashboard_errors) = class $bog_metrics_dashboard_errors extends ($.$mol_page) {
		total_errors(){
			return "0";
		}
		Total_card(){
			const obj = new this.$.$bog_metrics_dashboard_stat_card();
			(obj.title) = () => ("Total errors");
			(obj.value) = () => ((this.total_errors()));
			return obj;
		}
		unique_errors(){
			return "0";
		...
		Unique_card(){
			const obj = new this.$.$bog_metrics_dashboard_stat_card();
			(obj.title) = () => ("Unique errors");
			(obj.value) = () => ((this.unique_errors()));
			return obj;
		}
		Summary(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([(this.Total_card()), (this.Unique_card())]);
			return obj;
		}
		error_message(id){
			return "";
		...
		Error_last_seen(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.error_last_seen(id)));
			return obj;
		}
		Error_details(id){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([(this.Error_count(id)), (this.Error_last_seen(id))]);
			return obj;
		}
		Error_row(id){
			const obj = new this.$.$mol_section();
			(obj.title) = () => ((this.error_message(id)));
			(obj.content) = () => ([(this.Error_details("0"))]);
			return obj;
		}
		error_rows(){
			return [(this.Error_row("0"))];
		}
		Errors_list(){
			const obj = new this.$.$mol_section();
			(obj.title) = () => ("Errors by message");
			(obj.content) = () => ((this.error_rows()));
			return obj;
		}
		title(){
			return "Errors";
		...
		body(){
			return [(this.Summary()), (this.Errors_list())];
		}
	};
	($mol_mem(($.$bog_metrics_dashboard_errors.prototype), "Total_card"));
	($mol_mem(($.$bog_metrics_dashboard_errors.prototype), "Unique_card"));
	($mol_mem(($.$bog_metrics_dashboard_errors.prototype), "Summary"));
	($mol_mem_key(($.$bog_metrics_dashboard_errors.prototype), "Error_count"));
	($mol_mem_key(($.$bog_metrics_dashboard_errors.prototype), "Error_last_seen"));
	($mol_mem_key(($.$bog_metrics_dashboard_errors.prototype), "Error_details"));
	($mol_mem_key(($.$bog_metrics_dashboard_errors.prototype), "Error_row"));
	($mol_mem(($.$bog_metrics_dashboard_errors.prototype), "Errors_list"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_metrics_dashboard_errors extends $.$bog_metrics_dashboard_errors {
            error_events() {
            ...
            errors_grouped() {
                ...
                for (const ev of this.error_events()) {
                    ...
                    if (existing) {
                        existing.count++;
                        if (ev.timestamp > existing.last_seen)
        ...
        __decorate([
            $mol_mem
        ], $bog_metrics_dashboard_errors.prototype, "error_events", null);
        __decorate([
            $mol_mem
        ], $bog_metrics_dashboard_errors.prototype, "errors_grouped", null);
        $$.$bog_metrics_dashboard_errors = $bog_metrics_dashboard_errors;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
